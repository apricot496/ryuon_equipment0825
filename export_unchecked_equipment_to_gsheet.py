...
RAW_RULES: dict[str, list[str]] = {
    ...
    "会心率減少": ["会心率***%減少", "会心率減少"],
    "敵回避率減少": ["敵の回避率を***%減少", "回避率を***%減少"],
    "敵攻撃減少": ["敵全体の攻撃力を***%減少", "敵の攻撃力を***秒間-***%減少", "敵の攻撃力を***秒間***%減少", "攻撃力を***%減少"],
    "敵速度減少": ["敵の速度を***秒間-***%減少", "速度を***%減少"],
    "敵防御減少": ["敵全体の防御力を***%減少", "敵の防御力を***秒間-***%減少", "敵の防御力を***秒間***%減少", "防御力を***%減少"],
    "特殊効果付与": ["秒間の泥酔", "秒間の睡眠", "特殊効果付与"],
    "特殊効果確率上昇": ["特殊効果の成功確率を***%上昇", "暗闇が成功する確率を***%上昇", "睡眠が成功する確率を***%上昇"],
    "状態異常付与": ["秒間の魅了付与", "秒間の封印付与", "秒間の混乱付与", "秒間の麻痺付与", "出血付与", "骨折付与", "打撲付与", "へ打撲", "回復不可付与", "状態異常付与"],
